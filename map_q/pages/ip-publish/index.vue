...
<style scoped>
.page{min-height:100vh;color: var(--color-text);background: var(--color-page)}.nav-btn{min-width:60px;height:44px;padding:0 10px;display:flex;align-items:center;justify-content:center;border-radius:14px;color: var(--color-text-body);background: var(--color-surface-muted);font-size:12px;font-weight:700}.nav-btn.save{color: var(--color-primary);background: var(--color-primary-soft)}.content{height:100vh;padding:14px 14px 108px;box-sizing:border-box}.identity-card,.official-row,.editor-card,.settings-card,.license-card{margin-bottom:12px;border: 1px solid var(--color-border);border-radius:20px;background: #fff;box-shadow:0 8px 24px rgba(0, 0, 0, 0.05)}.identity-card{min-height:74px;padding:10px 14px;display:flex;align-items:center;gap:12px}.ip-mark{width:48px;height:48px;border-radius:15px;display:flex;align-items:center;justify-content:center;color: #fff;background: var(--color-primary);font-size:16px;font-weight:850}.identity-copy{flex:1}.identity-copy text{display:block}.identity-copy text:first-child{font-size:15px;font-weight:800}.identity-copy text:last-child{margin-top:4px;color: #b45309;font-size:10px}.identity-copy text.verified{color: #15803d}.chevron{color: var(--color-text-muted);font-size:24px}.official-row{min-height:68px;padding:9px 14px;display:flex;align-items:center;justify-content:space-between;gap:12px}.official-row text{display:block}.official-row text:first-child{font-size:14px;font-weight:700}.official-row text:last-child{margin-top:4px;color: var(--color-text-body);font-size:10px}.official-row.disabled{opacity:.58}.switch{position:relative;width:48px;height:28px;border-radius:14px;background: #cbd5e1}.switch view{position:absolute;top:3px;left:3px;width:22px;height:22px;border-radius:50%;background: #cbd5e1;transition:transform 180ms ease}.switch.active{background: var(--color-primary)}.switch.active view{transform:translateX(20px)}.editor-card,.license-card{padding:16px}.section-title{display:block;font-size:16px;font-weight:800}.editor-card textarea{width:100%;min-height:140px;margin-top:9px;font-size:16px;line-height:1.65}.counter{display:block;color: var(--color-text-muted);font-size:11px;text-align:right}.settings-card{padding:2px 16px}.setting-row{min-height:76px;display:flex;align-items:center;justify-content:space-between;gap:14px;border-bottom: 1px solid var(--color-surface-muted)}.setting-row:last-child{border-bottom: 0}.setting-row text{display:block}.setting-row>view:first-child text:first-child{font-size:14px;font-weight:700}.setting-row>view:first-child text:last-child{margin-top:4px;color: var(--color-text-body);font-size:10px}.value{max-width:45%;display:flex;align-items:center;color: var(--color-text-body);font-size:11px;text-align:right}.value text{margin-left:6px;font-size:20px}.license-card>text:nth-child(2){display:block;margin-top:10px;color: var(--color-text);font-size:12px;line-height:1.65}.immutable-tip{display:block;margin-top:10px;padding:9px;border-radius:11px;color: var(--color-primary);background: var(--color-primary-soft);font-size:10px;line-height:1.5}.error{display:block;margin:8px 4px;color: #b91c1c;font-size:12px}.footer{position:fixed;z-index:100;left:0;right:0;bottom:0;min-height:76px;padding:10px 14px calc(10px + env(safe-area-inset-bottom));display:flex;align-items:center;gap:12px;background: rgba(255,255,255,.97);border-top: 1px solid var(--color-border);box-sizing:content-box}.footer>view:first-child{flex:1}.footer text{display:block}.footer text:first-child{font-size:12px;font-weight:700}.footer text:last-child{margin-top:3px;color: var(--color-text-body);font-size:10px}.preview-btn{min-width:138px;height:50px;display:flex;align-items:center;justify-content:center;border-radius:15px;color: #fff;background: var(--color-primary);font-size:13px;font-weight:750}.safe-space{height:20px}@media(prefers-reduced-motion:reduce){.switch view{transition:none}}
</style>
