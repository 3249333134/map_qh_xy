...
<style scoped>
.page { min-height: 100vh; color: var(--color-text); background: var(--color-page); }.nav-action { min-width: 54px; height: 44px; display: flex; align-items: center; justify-content: center; border-radius: 14px; font-size: 14px; font-weight: 700; }.nav-action.secondary { color: var(--color-text-body); background: var(--color-surface-muted); }.nav-action.preview { color: #fff; background: var(--color-primary); }.page-scroll { height: 100vh; padding: 14px; box-sizing: border-box; }.editor-card,.settings-card,.form-card { margin-bottom: 12px; padding: 16px; border: 1px solid var(--color-border); border-radius: 20px; background: #fff; box-shadow: 0 8px 24px rgba(0, 0, 0, 0.05); }.field-label,.section-title,.section-hint,.field-error,.counter,.setting-label,.setting-help { display: block; }.field-label,.section-title { color: var(--color-text); font-size: 16px; font-weight: 750; }.content-input { width: 100%; min-height: 150px; margin-top: 10px; font-size: 16px; line-height: 1.65; }.input-meta { display: flex; justify-content: space-between; gap: 10px; }.counter { margin-left: auto; color: var(--color-text-muted); font-size: 11px; font-variant-numeric: tabular-nums; }.field-error,.standalone-error { color: #b91c1c; font-size: 12px; }.standalone-error { display: block; margin: -2px 4px 12px; }.settings-card { padding-top: 2px; padding-bottom: 2px; }.setting-row { min-height: 70px; display: flex; align-items: center; justify-content: space-between; gap: 16px; border-bottom: 1px solid var(--color-surface-muted); }.setting-row:last-child { border-bottom: 0; }.setting-label { font-size: 14px; font-weight: 700; }.setting-help { margin-top: 4px; color: var(--color-text-body); font-size: 11px; }.setting-value { max-width: 48%; display: flex; align-items: center; color: var(--color-text-body); font-size: 13px; text-align: right; }.chevron { margin-left: 7px; color: var(--color-text-muted); font-size: 22px; }.section-hint { margin-top: 10px; color: var(--color-text-body); font-size: 11px; line-height: 1.5; }.segmented { margin-top: 13px; padding: 4px; display: grid; grid-template-columns: repeat(3,1fr); gap: 4px; border-radius: 15px; background: var(--color-surface-muted); }.segmented view { min-height: 44px; display: flex; align-items: center; justify-content: center; border-radius: 12px; color: var(--color-text-body); font-size: 13px; }.segmented view.active { color: var(--color-primary); background: #fff; box-shadow: 0 3px 10px rgba(0, 0, 0, 0.08); font-weight: 700; }.input-field { margin-top: 14px; }.input-field>text { display: block; color: var(--color-text); font-size: 12px; font-weight: 700; }.input-field input,.input-field textarea { width: 100%; min-height: 48px; margin-top: 7px; padding: 11px 12px; border-radius: 13px; background: var(--color-page); box-sizing: border-box; font-size: 14px; }.input-field textarea { min-height: 90px; }.draft-tip { height: 44px; display: flex; align-items: center; justify-content: center; gap: 7px; color: var(--color-text-body); font-size: 11px; }.save-dot { width: 7px; height: 7px; border-radius: 50%; background: #22c55e; }.safe-space { height: calc(34px + env(safe-area-inset-bottom)); }
</style>
