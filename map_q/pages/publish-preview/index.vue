...
<style scoped>
.page { min-height: 100vh; color: #182033; background: var(--color-page); }.nav-btn { min-width: 76px; height: 44px; padding: 0 10px; display: flex; align-items: center; justify-content: center; border-radius: 14px; color: #475569; background: #f1f5f9; font-size: 12px; font-weight: 700; }.nav-btn.primary { color: #fff; background: var(--color-primary); }.nav-btn.disabled { opacity: .45; }.content { height: 100vh; padding: 14px; box-sizing: border-box; }.notice { min-height: 54px; padding: 9px 12px; display: flex; align-items: center; gap: 10px; border-radius: 16px; color: #475569; background: #eaf8f5; font-size: 12px; line-height: 1.5; }.notice-icon { width: 18px; height: 18px; flex: 0 0 18px; border: 2px solid #16b8a7; border-radius: 50%; position: relative; }.notice-icon::after { content: ''; position: absolute; left: 7px; top: 4px; width: 2px; height: 7px; border-radius: 1px; background: #16b8a7; }.preview-card,.summary-card,.error-card { margin-top: 12px; padding: 16px; border: 1px solid #e3e9f3; border-radius: 20px; background: #fff; box-shadow: 0 8px 24px rgba(15,23,42,.05); }.author-row { display: flex; align-items: center; gap: 10px; }.avatar { width: 44px; height: 44px; border-radius: 14px; display: flex; align-items: center; justify-content: center; color: #fff; background: #16b8a7; font-weight: 800; }.author,.status { display: block; }.author { font-size: 14px; font-weight: 750; }.status { margin-top: 3px; color: #5c667a; font-size: 10px; }.body { display: block; margin-top: 15px; font-size: 16px; line-height: 1.7; white-space: pre-wrap; }.media-grid { margin-top: 14px; display: grid; grid-template-columns: repeat(3,1fr); gap: 5px; overflow: hidden; border-radius: 14px; }.media-grid.single { grid-template-columns: 1fr; }.media-grid image { width: 100%; aspect-ratio: 1; }.media-grid.single image { aspect-ratio: 4/3; }.chips { margin-top: 13px; display: flex; flex-wrap: wrap; gap: 7px; }.chips text { padding: 6px 9px; border-radius: 999px; color: #087f75; background: #eaf8f5; font-size: 11px; }.chips .location-chip { color: var(--color-primary); background: #fff1ee; }.section-title { display: block; margin-bottom: 8px; font-size: 16px; font-weight: 800; }.summary-row { min-height: 43px; display: flex; align-items: center; justify-content: space-between; gap: 20px; border-bottom: 1px solid #f1f5f9; color: #5c667a; font-size: 12px; }.summary-row text:last-child { max-width: 64%; color: #5c667a; text-align: right; }.license-summary { padding: 12px 0 2px; }.license-summary text { display: block; }.license-summary text:first-child { font-size: 12px; font-weight: 700; }.license-summary text:last-child { margin-top: 5px; color: #5c667a; font-size: 11px; line-height: 1.6; }.error-card { border-color: #fecaca; background: #fff; }.error-card>text:not(.section-title) { display: block; margin-top: 6px; color: #991b1b; font-size: 12px; }.safe-space { height: calc(28px + env(safe-area-inset-bottom)); }.empty { padding-top: 180px; text-align: center; color: #5c667a; }.empty view { width: 120px; height: 46px; margin: 20px auto; display: flex; align-items: center; justify-content: center; border-radius: 14px; color: #fff; background: var(--color-primary); }
