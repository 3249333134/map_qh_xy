...
<style scoped>
.page{min-height:100vh;background: var(--color-page)}.nav-btn{min-width:56px;height:44px;padding:0 10px;display:flex;align-items:center;justify-content:center;border-radius:14px;color: var(--color-text-body);background: var(--color-surface-muted);font-size:12px;font-weight:700}.nav-btn.done{color: #fff;background: var(--color-primary)}.content{padding:14px}.notice{padding:12px;border-radius:15px;color: #92400e;background: #fffbeb;font-size:12px;line-height:1.55}.list{margin-top:12px;overflow:hidden;border-radius:20px;background: #fff}.profile{min-height:76px;padding:10px 14px;display:flex;align-items:center;gap:12px;border-bottom: 1px solid var(--color-surface-muted)}.profile:last-child{border-bottom: 0}.profile.active{background: var(--color-primary-soft)}.mark{width:48px;height:48px;border-radius:15px;display:flex;align-items:center;justify-content:center;color: #fff;background: var(--color-primary);font-weight:850}.copy{flex:1}.copy text{display:block}.copy text:first-child{font-size:14px;font-weight:800}.copy text:last-child{margin-top:4px;color: #b45309;font-size:10px}.copy text.verified{color: #15803d}.radio{width:24px;height:24px;border: 2px solid #cbd5e1;border-radius:50%;display:flex;align-items:center;justify-content:center}.active .radio{border-color: var(--color-primary)}.radio view{width:12px;height:12px;border-radius:50%;background: var(--color-primary)}
</style>
