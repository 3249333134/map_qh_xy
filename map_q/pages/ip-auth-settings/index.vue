...
<style scoped>
.page{min-height:100vh;color: var(--color-text);background: var(--color-page)}.nav-btn{min-width:56px;height:44px;padding:0 10px;display:flex;align-items:center;justify-content:center;border-radius:14px;color: var(--color-text-body);background: var(--color-surface-muted);font-size:12px;font-weight:700}.nav-btn.done{color: #fff;background: var(--color-primary)}.content{height:100vh;padding:14px;box-sizing:border-box}.form-card,.summary-card,.error-card{margin-bottom:12px;padding:16px;border: 1px solid #e3e9f3;border-radius:20px;background: #fff;box-shadow:0 8px 24px rgba(15,23,42,.05)}.section-title{display:block;margin-bottom:8px;font-size:16px;font-weight:800}.switch-row{min-height:68px;display:flex;align-items:center;justify-content:space-between;gap:14px;border-bottom: 1px solid var(--color-surface-muted)}.switch-row:last-child{border-bottom: 0}.switch-row text{display:block}.switch-row text:first-child{font-size:14px;font-weight:700}.switch-row text:last-child{margin-top:4px;color: var(--color-text-body);font-size:10px}.toggle{position:relative;flex:0 0 48px;width:48px;height:28px;border-radius:14px;background: #cbd5e1}.toggle view{position:absolute;top:3px;left:3px;width:22px;height:22px;border-radius:50%;background: #cbd5e1;transition:transform 180ms ease}.toggle.active{background: var(--color-primary)}.toggle.active view{transform:translateX(20px)}.field{display:block;padding:12px 0;border-bottom: 1px solid var(--color-surface-muted)}.field>text{display:block;color: var(--color-text);font-size:12px;font-weight:700}.field input,.field picker,.field textarea,.field picker view{width:100%;min-height:44px;margin-top:5px;display:flex;align-items:center;font-size:14px}.field textarea{min-height:80px}.summary-card>text:last-child{display:block;color: var(--color-text-body);font-size:12px;line-height:1.65}.error-card{border-color: #fecaca;background: #fff}.error-card text{display:block;margin:4px 0;color: #991b1b;font-size:12px}.safe-space{height:calc(24px + env(safe-area-inset-bottom))}@media(prefers-reduced-motion:reduce){.toggle view{transition:none}}
</style>
