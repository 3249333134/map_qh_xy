...
<style scoped>
.page{min-height:100vh;color: var(--color-text);background: var(--color-page)}.nav-btn{min-width:64px;height:44px;padding:0 10px;display:flex;align-items:center;justify-content:center;border-radius:14px;color: var(--color-text-body);background: var(--color-surface-muted);font-size:12px;font-weight:700}.nav-btn.save{color: var(--color-primary);background: var(--color-primary-soft)}.content{height:100vh;padding:14px 14px 110px;box-sizing:border-box}.private-banner{min-height:66px;margin-bottom:12px;padding:10px 12px;display:flex;align-items:center;gap:11px;border-radius:18px;color: #5b21b6;background: #f5f3ff}.private-mark{width:42px;height:42px;border-radius:13px;display:flex;align-items:center;justify-content:center;color: #fff;background: var(--color-info);font-weight:800}.private-banner text{display:block}.private-banner text:first-child{font-size:14px;font-weight:750}.private-banner text:last-child{margin-top:3px;color: #6d28d9;font-size:10px}.editor-card,.form-card,.settings-card{margin-bottom:12px;padding:16px;border: 1px solid var(--color-border);border-radius:20px;background: #fff;box-shadow:0 8px 24px rgba(0, 0, 0, 0.05)}.section-title{display:block;font-size:16px;font-weight:800}.editor-card textarea{width:100%;min-height:140px;margin-top:9px;font-size:16px;line-height:1.65}.counter{display:block;color: var(--color-text-muted);font-size:11px;text-align:right}.category-list{margin-top:13px;display:flex;flex-wrap:wrap;gap:8px}.category-list view{min-height:44px;padding:0 14px;display:flex;align-items:center;border-radius:13px;color: var(--color-text-body);background: var(--color-surface-muted);font-size:12px}.category-list view.active{color: #5b21b6;background: #f1efff;font-weight:700}.category-list .add-category{color: var(--color-primary);background: var(--color-primary-soft)}.settings-card{padding-top:2px;padding-bottom:2px}.setting-row{min-height:76px;display:flex;align-items:center;justify-content:space-between;gap:14px;border-bottom: 1px solid var(--color-surface-muted)}.setting-row:last-child{border-bottom: 0}.setting-row text{display:block}.setting-row>view:first-child text:first-child{font-size:14px;font-weight:700}.setting-row>view:first-child text:last-child{margin-top:4px;color: var(--color-text-body);font-size:10px}.value{max-width:42%;display:flex;align-items:center;color: var(--color-text-body);font-size:11px;text-align:right}.value text{margin-left:6px;font-size:20px}.schedule-record{min-height:62px;display:flex;align-items:center;justify-content:space-between;gap:10px;border-bottom: 1px solid var(--color-surface-muted)}.schedule-record text{display:block}.schedule-record text:first-child{font-size:12px;font-weight:700}.schedule-record text:last-child{margin-top:3px;color: var(--color-text-body);font-size:10px}.cancel-schedule{min-width:60px;height:44px;display:flex;align-items:center;justify-content:center;border-radius:13px;color: #b91c1c;background: #fef2f2;font-size:11px;font-weight:700}.error{display:block;margin:8px 4px;color: #b91c1c;font-size:12px}.footer{position:fixed;z-index:100;left:0;right:0;bottom:0;min-height:78px;padding:10px 14px calc(10px + env(safe-area-inset-bottom));display:flex;align-items:center;gap:12px;background: rgba(255,255,255,.97);border-top: 1px solid var(--color-border);box-sizing:content-box}.footer-copy{flex:1}.footer-copy text{display:block}.footer-copy text:first-child{color: var(--color-text-body);font-size:10px}.footer-copy text:last-child{margin-top:3px;font-size:12px;font-weight:700}.preview-btn{min-width:154px;height:50px;display:flex;align-items:center;justify-content:center;border-radius:15px;color: #fff;background: var(--color-primary);font-size:13px;font-weight:750}.safe-space{height:20px}
</style>
