...
<style scoped>
.page { min-height: 100vh; background: var(--color-page); }.back-button { width: 44px; height: 44px; border-radius: 15px; display: flex; align-items: center; justify-content: center; background: var(--color-surface-muted); }.back-button view { width: 10px; height: 10px; border-left: 2px solid var(--color-text); border-bottom: 2px solid var(--color-text); transform: rotate(45deg); }.content { height: 100vh; padding: 14px; box-sizing: border-box; }
.verification-card { display: flex; align-items: center; gap: 11px; padding: 14px; border: 1px solid #ffd7df; border-radius: 19px; background: var(--color-primary-soft); }.verification-card.verified { border-color: #bbf7d0; background: #f0fdf4; }.verification-mark { width: 44px; height: 44px; border-radius: 14px; display: flex; align-items: center; justify-content: center; background: var(--color-primary-soft); }.verified .verification-mark { background: #dcfce7; }.verification-mark view { width: 16px; height: 19px; border: 2px solid var(--color-primary); border-radius: 8px 8px 10px 10px; }.verified .verification-mark view { border-color: #15803d; }.verification-copy { flex: 1; }.verification-copy text,.page-title,.page-subtitle,.event-title,.event-meta,.capacity-copy text,.empty-card text,.editor-head text,.editor-form label>text { display: block; }.verification-copy text:first-child { color: #9a3412; font-size: 14px; font-weight: 750; }.verified .verification-copy text:first-child { color: #166534; }.verification-copy text:last-child { margin-top: 4px; color: var(--color-text-body); font-size: 11px; }.verify-action { min-height: 40px; padding: 0 12px; border-radius: 13px; display: flex; align-items: center; color: #9a3412; background: #fff; font-size: 12px; font-weight: 700; }
.toolbar { margin: 20px 2px 12px; display: flex; align-items: center; justify-content: space-between; }.page-title { color: var(--color-text); font-size: 20px; font-weight: 800; }.page-subtitle { margin-top: 3px; color: var(--color-text-body); font-size: 11px; }.create-button { min-height: 44px; padding: 0 15px; border-radius: 14px; display: flex; align-items: center; color: #fff; background: var(--color-primary); font-size: 13px; font-weight: 750; }
.event-card,.empty-card { margin-bottom: 12px; padding: 15px; border: 1px solid var(--color-border); border-radius: 19px; background: #fff; box-shadow: 0 7px 22px rgba(0, 0, 0, 0.05); }.event-head { display: flex; justify-content: space-between; gap: 12px; }.event-title { color: var(--color-text); font-size: 16px; font-weight: 750; }.event-meta { margin-top: 5px; color: var(--color-text-body); font-size: 11px; }.status-chip { height: 28px; padding: 0 9px; border-radius: 10px; display: flex; align-items: center; color: #475569; background: #f1f5f9; font-size: 10px; font-weight: 700; }.status-chip.published { color: #166534; background: #dcfce7; }.status-chip.cancelled { color: #991b1b; background: #fee2e2; }
.capacity-row { margin-top: 16px; }.capacity-copy { display: flex; justify-content: space-between; }.capacity-copy text { color: var(--color-text-body); font-size: 11px; }.capacity-copy text:last-child { color: var(--color-text-body); font-weight: 700; }.capacity-track { height: 6px; margin-top: 7px; overflow: hidden; border-radius: 6px; background: var(--color-border); }.capacity-track view { height: 100%; border-radius: 6px; background: var(--color-primary); }.event-actions { margin-top: 14px; display: flex; flex-wrap: wrap; gap: 8px; }.event-actions view { min-height: 40px; padding: 0 12px; border-radius: 12px; display: flex; align-items: center; color: var(--color-text-body); background: var(--color-surface-muted); font-size: 11px; font-weight: 700; }.event-actions .primary { color: #fff; background: var(--color-primary); }.event-actions .danger { color: #b91c1c; background: #fef2f2; }
.empty-card { padding: 38px 20px; text-align: center; }.empty-graphic { width: 62px; height: 62px; margin: auto; border-radius: 20px; display: flex; align-items: center; justify-content: center; background: var(--color-primary-soft); }.empty-graphic view { width: 25px; height: 21px; border: 3px solid var(--color-primary); border-radius: 6px; box-shadow: 6px 6px 0 -3px #eaf8f5,6px 6px 0 0 #16b8a7; }.empty-card text:nth-child(2) { margin-top: 18px; color: var(--color-text); font-size: 16px; font-weight: 750; }.empty-card text:nth-child(3) { margin-top: 6px; color: var(--color-text-body); font-size: 11px; }.empty-card>view:last-child { width: 150px; height: 46px; margin: 20px auto 0; border-radius: 14px; display: flex; align-items: center; justify-content: center; color: #fff; background: #fff; font-size: 13px; font-weight: 750; }.bottom-space { height: 40px; }
.editor-scrim { position: fixed; z-index: 1200; inset: 0; background: rgba(15,23,42,.48); }.editor-sheet { position: fixed; z-index: 1210; left: 0; right: 0; bottom: 0; height: 82vh; padding: 8px 16px calc(12px + env(safe-area-inset-bottom)); border-radius: 28px 28px 0 0; background: #fff; box-sizing: border-box; }.sheet-handle { width: 36px; height: 4px; margin: 0 auto 12px; border-radius: 4px; background: #cbd5e1; }.editor-head { display: flex; align-items: center; justify-content: space-between; }.editor-head text:first-child { color: var(--color-text); font-size: 20px; font-weight: 800; }.editor-head text:last-child { margin-top: 3px; color: var(--color-text-body); font-size: 11px; }.close-button { position: relative; width: 44px; height: 44px; border-radius: 14px; background: var(--color-surface-muted); }.close-button::before,.close-button::after { content: ''; position: absolute; left: 14px; top: 21px; width: 16px; height: 2px; background: var(--color-text-body); transform: rotate(45deg); }.close-button::after { transform: rotate(-45deg); }
.editor-form { height: calc(82vh - 146px); margin-top: 10px; }.editor-form label { display: block; padding: 10px 0; }.editor-form label>text { color: var(--color-text); font-size: 12px; font-weight: 650; }.editor-form input,.editor-form textarea { width: 100%; min-height: 46px; margin-top: 7px; padding: 0 12px; border: 1px solid var(--color-border); border-radius: 13px; box-sizing: border-box; font-size: 14px; }.editor-form textarea { min-height: 78px; padding-top: 12px; }.two-column { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; }.editor-footer { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; padding-top: 10px; border-top: 1px solid var(--color-surface-muted); }.secondary-action,.primary-action { height: 48px; border-radius: 15px; display: flex; align-items: center; justify-content: center; font-size: 13px; font-weight: 750; }.secondary-action { color: var(--color-text-body); background: var(--color-surface-muted); }.primary-action { color: #fff; background: var(--color-primary); }
</style>
