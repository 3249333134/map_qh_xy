...
<style scoped>
.page{position:relative;height:100vh;overflow:hidden;color: var(--color-text);background: var(--color-border)}.map{width:100%;height:35vh}.nav{position:absolute;z-index:20;top:0;left:0;right:0;height:44px;padding-left:14px;padding-right:14px;display:flex;align-items:center;justify-content:space-between;box-sizing:content-box;background: rgba(255,255,255,.9);backdrop-filter:blur(10px)}.nav>text{font-size:17px;font-weight:800}.back,.submit{min-width:44px;height:44px;display:flex;align-items:center;justify-content:center;border-radius:14px}.back{background: var(--color-surface-muted)}.back view{width:10px;height:10px;border-left: 2px solid var(--color-text);border-bottom: 2px solid var(--color-text);transform:rotate(45deg)}.submit{padding:0 11px;color: #fff;background: var(--color-primary);font-size:12px;font-weight:750}.submit.disabled{opacity:.45}.sheet{position:absolute;z-index:10;left:0;right:0;bottom:0;height:68vh;padding:10px 14px;box-sizing:border-box;border-radius:26px 26px 0 0;background: var(--color-page);box-shadow:0 -12px 30px rgba(0, 0, 0, 0.12)}.handle{width:42px;height:5px;margin:0 auto 12px;border-radius:3px;background: #cbd5e1}.candidate-banner{min-height:62px;padding:9px 12px;display:flex;align-items:center;gap:11px;border-radius:17px;color: #92400e;background: #fffbeb}.candidate-icon{width:34px;height:34px;border: 3px dashed #d97706;border-radius:50%}.candidate-banner text{display:block}.candidate-banner text:first-child{font-size:13px;font-weight:800}.candidate-banner text:last-child{margin-top:3px;font-size:10px}.coordinate-card,.form-card,.duplicate-card,.history-card{margin-top:12px;padding:14px;border: 1px solid var(--color-border);border-radius:20px;background: #fff;box-shadow:0 8px 24px rgba(0, 0, 0, 0.05)}.coordinate-card{min-height:62px;display:flex;align-items:center;justify-content:space-between;gap:12px}.coordinate-card text{display:block}.coordinate-card text:first-child{font-size:12px;font-weight:700}.coordinate-card text:last-child{margin-top:4px;color: var(--color-text-body);font-size:10px;font-variant-numeric:tabular-nums}.locate,.check-btn,.duplicate-action,.appeal{min-width:72px;height:44px;padding:0 9px;display:flex;align-items:center;justify-content:center;border-radius:13px;color: var(--color-primary);background: var(--color-primary-soft);font-size:10px;font-weight:700}.field{display:block;padding:11px 0;border-bottom: 1px solid var(--color-surface-muted)}.field:last-child{border-bottom: 0}.field>text{display:block;font-size:12px;font-weight:700}.required,.error{color: #b91c1c}.field input,.field picker,.field textarea,.picker-value{width:100%;min-height:44px;margin-top:4px;display:flex;align-items:center;font-size:14px}.picker-value{justify-content:space-between}.picker-value text{font-size:20px;color: var(--color-text-muted)}.field textarea{min-height:98px;line-height:1.6}.duplicate-head{display:flex;align-items:center;justify-content:space-between;gap:12px}.duplicate-head text{display:block}.duplicate-head text:first-child,.section-title{font-size:14px;font-weight:800}.duplicate-head text:last-child{margin-top:4px;color: var(--color-text-body);font-size:10px}.check-empty{min-height:58px;margin-top:10px;display:flex;align-items:center;gap:9px;color: #15803d;font-size:11px}.check-empty view{width:18px;height:18px;border: 2px solid #22c55e;border-radius:50%}.duplicate-row,.history-row{min-height:62px;display:flex;align-items:center;justify-content:space-between;gap:10px;border-top: 1px solid var(--color-surface-muted)}.duplicate-row text,.history-row text{display:block}.duplicate-row text:first-child,.history-row text:first-child{font-size:12px;font-weight:700}.duplicate-row text:last-child,.history-row text:last-child{margin-top:4px;color: #b45309;font-size:10px}.duplicate-action{color: #92400e;background: var(--color-primary-soft)}.history-card>.section-title{display:block;margin-bottom:6px}.appeal{color: #b91c1c;background: var(--color-primary-soft)}.error{display:block;margin:8px 4px;font-size:12px}.safe-space{height:calc(28px + env(safe-area-inset-bottom))}
</style>
