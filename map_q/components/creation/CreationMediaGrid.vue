...
<style scoped>
.media-block { padding: 16px; border: 1px solid var(--color-border); border-radius: 20px; background: #fff; box-shadow: 0 8px 24px rgba(0, 0, 0, 0.05); }
.section-head { display: flex; align-items: flex-start; justify-content: space-between; gap: 12px; }.section-title,.section-hint { display: block; }.section-title { color: var(--color-text); font-size: 16px; font-weight: 750; }.section-hint { margin-top: 4px; color: var(--color-text-body); font-size: 11px; }.media-count { color: var(--color-text-muted); font-size: 12px; font-variant-numeric: tabular-nums; }
.media-grid { margin-top: 14px; display: grid; grid-template-columns: repeat(3,minmax(0,1fr)); gap: 9px; }.media-card,.add-card { position: relative; aspect-ratio: 1; overflow: hidden; border-radius: 15px; }.media-card { background: var(--color-border); }.media-preview { width: 100%; height: 100%; }.media-state { position: absolute; left: 6px; right: 6px; bottom: 50px; padding: 5px 6px; border-radius: 9px; color: #fff; background: rgba(15,23,42,.78); font-size: 9px; }.media-state.succeeded { color: #166534; background: rgba(240,253,244,.94); }.media-state.failed,.media-state.needs_reselect { color: #991b1b; background: rgba(254,242,242,.96); }.progress-track { height: 3px; margin-top: 4px; overflow: hidden; border-radius: 2px; background: rgba(255,255,255,.28); }.progress-track view { height: 100%; background: var(--color-primary); transition: width 150ms ease; }.media-actions { position: absolute; left: 5px; right: 5px; bottom: 4px; display: flex; justify-content: flex-end; gap: 5px; }.media-action { min-width: 44px; height: 44px; padding: 0 7px; display: flex; align-items: center; justify-content: center; border-radius: 11px; color: #fff; background: rgba(15,23,42,.84); font-size: 10px; box-sizing: border-box; }.media-action.retry { color: #9a3412; background: var(--color-primary-soft); }
.add-card { min-height: 96px; border: 1px dashed #cbd5e1; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 7px; color: var(--color-text-body); background: var(--color-page); font-size: 11px; }.image-glyph { position: relative; width: 24px; height: 20px; border: 2px solid var(--color-text-body); border-radius: 5px; }.image-glyph::before { content: ''; position: absolute; left: 4px; top: 4px; width: 4px; height: 4px; border-radius: 50%; background: var(--color-primary); }.image-glyph view { position: absolute; left: 4px; right: 4px; bottom: 3px; height: 7px; border-left: 2px solid var(--color-text-body); border-top: 2px solid var(--color-text-body); transform: skew(-28deg); }.video-glyph { position: relative; width: 25px; height: 20px; border: 2px solid var(--color-text-body); border-radius: 5px; }.video-glyph::after { content: ''; position: absolute; right: 6px; top: 4px; border-left: 7px solid var(--color-primary); border-top: 5px solid transparent; border-bottom: 5px solid transparent; }.field-error { display: block; margin-top: 10px; color: #b91c1c; font-size: 12px; }
